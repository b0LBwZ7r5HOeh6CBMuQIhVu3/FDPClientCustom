...
import net.ccbluex.liquidbounce.features.module.modules.exploit.VanillaAura;
...
public abstract class MixinItemRenderer {
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        ...
        if (this.itemToRender != null) {
            boolean displayBlocking = LiquidBounce.moduleManager.getModule(KillAura.class).getDisplayBlocking() || LiquidBounce.moduleManager.getModule(VanillaAura.class).shouldDisplayBlocking();
