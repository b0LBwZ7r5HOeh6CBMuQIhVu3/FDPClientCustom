    ...
    override fun execute(args: Array<String>) {
        if (args.size == 2) {
            ...
            if (targetPlayer != null) {
                ...
                mc.getNetHandler().addToSendQueue(C03PacketPlayer.C04PacketPlayerPosition(mc.thePlayer.posX, mc.thePlayer.posY-2, mc.thePlayer.posZ, true))
                mc.getNetHandler().addToSendQueue(C03PacketPlayer.C04PacketPlayerPosition(targetPlayer!!.posX, targetPlayer!!.posY+0.41999998688698, targetPlayer!!.posZ, false))
                mc.getNetHandler().addToSendQueue(C03PacketPlayer.C04PacketPlayerPosition(targetPlayer!!.posX, targetPlayer!!.posY+0.7531999805212, targetPlayer!!.posZ, false))
            ...
            try {
                ...
                mc.getNetHandler().addToSendQueue(C03PacketPlayer.C04PacketPlayerPosition(mc.thePlayer.posX, mc.thePlayer.posY-2, mc.thePlayer.posZ, true))
                mc.getNetHandler().addToSendQueue(C03PacketPlayer.C04PacketPlayerPosition(posX, posY+0.41999998688698, posZ, false))
                mc.getNetHandler().addToSendQueue(C03PacketPlayer.C04PacketPlayerPosition(posX, posY+0.7531999805212, posZ, false)) 
