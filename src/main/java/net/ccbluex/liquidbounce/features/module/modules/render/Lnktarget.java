...
public class Lnktarget extends Module {
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        RenderUtils.drawGradientSidewaysLBP(customX.get() + x + 37.5, customY.get() + y + 13.5, customX.get() + x + 37.5 + animation, customY.get() + y + 16.5, new Color(225, 50, 50).getRGB(), customColor.getRGB());
