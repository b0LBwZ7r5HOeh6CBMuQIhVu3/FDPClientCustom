...
class Jesus : Module() {
    val modeValue = ListValue("Mode", arrayOf("Vanilla","medusa","vulcan", "NCP", "Jump", "AAC", "AACFly", "AAC3.3.11", "AAC4.2.1","AACTest" , "Horizon1.4.6", "Spartan", "Twilight", "Matrix", "Dolphin", "Legit","Speed"), "Vanilla")
