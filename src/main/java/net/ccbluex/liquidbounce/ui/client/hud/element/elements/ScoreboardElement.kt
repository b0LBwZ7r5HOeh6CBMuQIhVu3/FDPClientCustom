...
class ScoreboardElement(
    ...
    private val huayutingFakeLevelValue = BoolValue("huayutingFakeLevel", true)
    private val oldLevellValue = IntegerValue("oldLevel", 0, 0, 40)
    private val fakeLevelValue = IntegerValue("FakeLevel", 100, 0, 255)
